...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "Uh-oh! You've woken up a sea monster. Please spend one turn watching the monster slamming at one of your ships."
        static let ComputerHitMonster = "Kudos! The computer stumpled upon a sea monster.  You may lean back and enjoy your extra turn while watching the sea monster stomp at an enemy ship."
